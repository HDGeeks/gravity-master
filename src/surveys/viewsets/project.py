...
class ProjectViewSet(viewsets.ModelViewSet):
    ...
    def get_permissions(self):
        ...
        if self.action in ['list','create','retrieve','update','partial_update','delete','destroy','getSurveysForProject']:
    ...
    def create(self, request , format = None):
        ...
        if not 'name' or not 'description' or not 'customer_id' or not 'location' or not 'noOfDataCollectors' or not 'budget' in request.data.keys():
    ...
    def update(self, request , format = None, pk = None):
        ...
        if not 'name' or not 'description' or not 'location' or not 'noOfDataCollectors' or not 'budget' in request.data.keys():
            return responses.BadRequestErrorHandler("All required fields must be input")
